		...
		<div style="min-height: 100vh; margin-left: 300px;">
			...
			<div id="ThongKe">
				...
				<div class="item-center">
					<div class="row">
						<form action="ThongKe.php" method="GET" class="row" style="margin-top: 20px; margin-right: 40px;">
							<input class="txt-input" type="text" placeholder="Nhập tên nhân viên" name="txtSearch"><br>
									...
									while ($row = $result->fetch_assoc()) {
										...
										<tr class="col1">
											...
											<th class="tt row btn-group">
												<a href="http://localhost/PharmacyManager/ADMIN/page/ThongKe/ChiTiet.php/?Ma_NCC=' . $row['Ma_NCC'] . '"><button class="btnChiTiet select">Xem</button></a>
